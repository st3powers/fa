...
lter_use <- lter_after_remove %>%
  mutate(biomass_dw = 1 * biomass_ww_m)
...
png(filename = "../Figures/biomass_test/madison-fa-omegas-combined.png", width = 9,
...
png(filename = "../Figures/biomass_test/madison-fa-omegas-combined_sharedX.png", width = 9,
    height = 4, units = "in", res = 500)
...
png(filename = "../Figures/biomass_test/pufa_secchi_MEMO_oneseason_onevalue.png",
    width = 4, height = 3, units = "in", res = 500)
pufa_secchi_MEMO_oneseason_onevalue
dev.off()

png(filename = "../Figures/biomass_test/pufasafa_secchi_MEMO_oneseason_onevalue.png",
    width = 4, height = 3, units = "in", res = 500)
pufasafa_secchi_MEMO_oneseason_onevalue
dev.off()

png(filename = "../Figures/biomass_test/omega6_omega3_ratio_MEMO_oneseason_onevalue.png",
    width = 4, height = 3, units = "in", res = 500)
omega63ratio_secchi_MEMO_oneseason_onevalue
dev.off()

png(filename = "../Figures/biomass_test/omega3_omega6_ratio_MEMO_oneseason_onevalue.png",
    width = 4, height = 3, units = "in", res = 500)
